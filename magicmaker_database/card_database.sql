...
(4, 'Revenge', '2BB', 'Instant', 6, 'Destroy target creature.\r\nPainstorm', 0, 0, -1, '', './card_images/Revenge.png'),
(5, 'Snowslide', 'SGW', 'Snow Instant', 5, 'Exile target creature. Its controller adds {C}{C}. Until end of turn, they don\'t lose this mana as steps and phases end.', 0, 0, -1, '', './card_images/Snowslide.png');
